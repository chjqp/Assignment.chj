...
cv2.createTrackbar('lowHue', 'colorTest', Icol[0], 255, lambda x:x)
cv2.createTrackbar('highHue', 'colorTest', Icol[1], 255, lambda x:x)

cv2.createTrackbar('lowSat', 'colorTest', Icol[2], 255, lambda x:x)
cv2.createTrackbar('highSat', 'colorTest', Icol[3], 255, lambda x:x)

cv2.createTrackbar('lowVal', 'colorTest', Icol[4], 255, lambda x:x)
cv2.createTrackbar('highVal', 'colorTest', Icol[5], 255, lambda x:x)
